...
1. Subir apenas o container do postgres
...
1. Entrar no container e executar o comando para popular o banco
...
1. Rode as migrations novamente
...
1. Executar o seguinte comando adequando a data:
